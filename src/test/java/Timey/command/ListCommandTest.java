...
class ListCommandTest {
    ...
    void execute_savedTimings_listsTimingsInStableOrder() {
        ...
        var result = new ListCommand().execute(TestTimeyModelFactory.create(store));
    ...
    void execute_noSavedTimings_displaysEmptyMessage() {
        var result = new ListCommand().execute(TestTimeyModelFactory.create(new InMemoryFixedCommuteStore()));
